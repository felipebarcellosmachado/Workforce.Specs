...
Estas regras aplicam-se a **todas** as camadas (Repository, API, Serviço HTTP e Frontend):
...
* **Para o repositório**: use este documento principal + `Components/Repository.md`.
